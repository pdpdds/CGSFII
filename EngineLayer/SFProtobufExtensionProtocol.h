...
class SFProtobufExtensionProtocol : public SFProtocol, public SFBasePacketProtocol
{
public:
	SFProtobufExtensionProtocol(void);
	virtual ~SFProtobufExtensionProtocol(void);
