...
void CDelayedDirectoryChangeHandler::SetPartialPathOffset(const CStdString & strWatchedDirName)
{
...
void CDelayedDirectoryChangeHandler::On_FileAdded(const CStdString & strFileName)
{
...
void CDelayedDirectoryChangeHandler::On_FileRemoved(const CStdString & strFileName)
{
	CDirChangeNotification * p = GetNotificationObject();
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_FileModified(const CStdString & strFileName)
{
	CDirChangeNotification * p = GetNotificationObject();
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_FileNameChanged(const CStdString & strOldFileName, const CStdString & strNewFileName)
{
	CDirChangeNotification * p = GetNotificationObject();	
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_ReadDirectoryChangesError(DWORD dwError, const CStdString & strDirectoryName)
{
	CDirChangeNotification * p = GetNotificationObject();
	ASSERT( p );
...
void CDelayedDirectoryChangeHandler::On_WatchStarted(DWORD dwError, const CStdString & strDirectoryName)
{
...
void CDelayedDirectoryChangeHandler::On_WatchStopped(const CStdString & strDirectoryName)
{
...
void CDelayedDirectoryChangeHandler::SetChangedDirectoryName(const CStdString & strChangedDirName)
{
	ASSERT( m_pRealHandler );
...
const CStdString & CDelayedDirectoryChangeHandler::GetChangedDirectoryName() const
{
	if( m_pRealHandler )
