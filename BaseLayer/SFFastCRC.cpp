...
static const unsigned int _CRC32[256] = {
...
bool SFFastCRC::GetCRC(const unsigned char* pBuffer, unsigned int BufferSize, unsigned int& CRC)
{
...
bool SFFastCRC::GetSimpleCRC(const char* pBuffer, unsigned int BufferSize, unsigned int& CRC)
{
...
bool SFFastCRC::GetZLibCRC(const unsigned char* pBuffer, unsigned int BufferSize, unsigned int& CRC)
{
	CRC = crc32(CRC, pBuffer, BufferSize);
	return true;
}

bool SFFastCRC::GetadlerCRC(const unsigned char* pBuffer, unsigned int BufferSize, unsigned int& CRC)
{
